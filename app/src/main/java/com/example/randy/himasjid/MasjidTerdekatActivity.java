...
public class MasjidTerdekatActivity extends FragmentActivity implements LocationListener {

        private String API_KEY_SERVER = "AIzaSyDpX_LNF60PGnj_-gdcpHA-mQUWZy-CxPg";
        ...
        private class PlacesTask extends AsyncTask<String, Integer, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog = new ProgressDialog(MasjidTerdekatActivity.this);
                progressDialog.setIndeterminate(false);
                progressDialog.setCancelable(true);
                progressDialog.setMessage("Memuat Masjid ...");
                progressDialog.show();
            }
